        ...
        <div class="navbar-content">
          ...
          <ul class="navbar-nav">
            ...
            $ncount = Auth::user()->unreadNotifications()->count();
               @endphp
                  <p id="notification-count">{{ $ncount }} New Notifications</p>
                  <a href="javascript:;" class="text-muted">Clear all</a>
                </div>
                <div class="p-1">
                ...
                @forelse ($user->notifications as $notification)
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2" onclick="markNotificationAsRead('{{ $notification->id }}')">
                    <div class="wd-30 ht-30 d-flex align-items-center justify-content-center bg-primary rounded-circle me-3">
                      <i class="icon-sm text-white" data-feather="gift"></i>
                    </div>
                    <div class="flex-grow-1 me-2">
                      <p>{{ $notification->data['message'] }}</p>
                      <p class="tx-12 text-muted">{{ Carbon\Carbon::parse($notification->created_at)->diffForHumans() }}</p>
                    </div>  
                  </a>
